...
class UpdateDriverProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'driver.license_number' => 'required|string|exists:drivers,license_number',
            ...
            // Route
            'route.route_name' => 'required|string|exists:routes,route_name',
            ...
            // Bus
            'bus.bus_number' => 'required|string|exists:buses,bus_number',
            'bus.registration_id' => 'required|string|exists:buses,registration_id',
